...
--
-- Host: localhost
-- Generation Time: Oct 25, 2017 at 02:13 PM
...
(1, 'Social Network', 'Welcome to ProLogin', '/var/www/uploads', 'uploads', 'test@test.com', 'logo.png', 0, 1, 'd/m/Y', 1, 'gif|png|jpg|jpeg', '', '', 0, '', '', '', '', 10028, '', 'USD', 1, '$', 0, 1, 1, 0, 5, 0, '', '', 0, '', '', 0, 'layout/themes/titan_layout.php', 1, 200, 200, 3600, '', '', 1, 1, 'Y/m/d H:i', 0);
