...
class User_Model extends CI_Model 
{
    ...
    public function get_names_com($name) 
    {
    	return $this->db->like("first_name", $name)->or_like("last_name", $name)->limit(3)->get("users");
    }
	public function get_trand_com($name) 
    {
    	return $this->db->like("hashtag", $name)->limit(3)->get("feed_hashtags");
    }
    ...
    {
    	return $this->db->like("first_name", $name)->or_like("last_name", $name)->limit(5)->get("users");
    }
	public function get_trand($name) 
    {
    	return $this->db->like("hashtag", $name)->limit(5)->get("feed_hashtags");
    }
