<div class="white-area-content">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="dpname-in" class="col-sm-2 control-label">Single point-value</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="single_point_value" name="single_point_value" placeholder=""><br />

                </div>
            </div>
            <div class="form-group">
                <label for="dpname-in" class="col-sm-2 control-label">currency rate-update</label>
                <div class="col-sm-10" id="curre_box">
                    <div class="v_1">

                        <input type="text" class="form-control" id="input-c">
                        <select id="s_c" class="form-control">
                    ...
                    <input type="text" class="form-control" value="" placeholder="Final value" name="currency_v" id="input-c_f">
...
<!--API-KEY:-  http://api.exchangeratesapi.io/v1/latest?access_key=558dd01f89c7d3b5edcf5530b441dda1 -->

<script>
    const select = document.querySelectorAll('#s_c');
    ...
    async function currency() {
        ...
        input[0].addEventListener('keyup', () => {
            ...
            document.getElementById("input-c_f").value = input[1].value;
        });
        input[1].addEventListener('keyup', () => {
            input[0].value = input[1].value * rates[select[0].value] / rates[select[1].value];
            document.getElementById("input-c_f").value = input[0].value;
        });
