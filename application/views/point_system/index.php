                    ...
                    <div class="column is-8">
                        ...
                        <div class="flex-table">
                            ...
                            <div class="flex-table-item">
                                <div class="product">
                                    <img src="<?php echo site_url() ?>assets/img/products/2.svg"><span class="product-name">Like</span>
                                </div>
                                <div class="quantity has-spinner">
                                    <div class="spinner">
                                        ...
                                        <?php foreach ($likes_c->result() as $user) {
                                        }
                                        $total_l = $user->likes;
                                        ?>
                                        <span class="value"><?php echo $total_l ?></span>
                                        <button class="add">
                                ...
                                <?php $total_single_l = $single_point_v*$total_l ;?>
                                <div class="total">
                                    <span class="has-price"><?php echo $total_single_l ?></span>
                                </div>
                            </div>
                            <!--Table item-->
                            <div class="flex-table-item">
                                <div class="product">
                                    <img src="<?php echo site_url() ?>assets/img/products/3.svg">
                                ...
                                <div class="quantity has-spinner">
                                    <div class="spinner">
                                        ...
                                        <?php foreach ($comments_c->result() as $user) {
                                        }
                                        $total_c = $user->comments;
                                        ?>
                                        <span class="value"><?php echo $total_c?></span>
                                        <button class="add">
                                            <i data-feather="plus"></i>
                                        </button>
                                        <input class="spinner-input" type="hidden" value="1">
                                ...
                                <?php $total_single_c = $single_point_v*$total_c ;?>
                                <div class="total">
                                    <span class="has-price"><?php echo $total_single_c?></span>
                                </div>
                            </div>
                            <!--Table item-->
                            <div class="flex-table-item">
                                <div class="product">
                                <img src="<?php echo site_url() ?>assets/img/products/4.svg">
                                ...
                                <div class="quantity has-spinner">
                                    <div class="spinner">
                                        ...
                                        <?php foreach ($posts->result() as $user) {
                                        }
                                        $total_p = count($posts->result_object);
                                        ?>
                                        <span class="value"><?php echo $total_p?></span>
                                        <button class="add">
                                            <i data-feather="plus"></i>
                                        </button>
                                        <input class="spinner-input" type="hidden" value="1">
                                ...
                                <?php $total_single_p = $single_point_v*$total_p ;?>
                                <div class="total">
                                    <span class="has-price"><?php echo $total_single_p ?></span>
                                </div>
                            </div>
                            <div class="flex-table-item">
                                <div class="product">
                                <img src="<?php echo site_url() ?>assets/img/products/5.svg">
                                ...
                                <div class="quantity has-spinner">
                                    <div class="spinner">
                                        ...
                                        <?php foreach ($images_c->result() as $user) {
                                        }
                                        $total_i = count($images_c->result_object);
                                        ?>
                                        <span class="value"><?php echo $total_i?></span>
                                        <button class="add">
                                            <i data-feather="plus"></i>
                                        </button>
                                        <input class="spinner-input" type="hidden" value="1">
                                ...
                                <?php $total_single_i = $single_point_v*$total_i ;?>
                                <div class="total">
                                    <span class="has-price"><?php echo $total_single_i ?></span>
                                </div>
                            </div>
                            <div class="flex-table-item">
                                <div class="product">
                                   
                                <img src="<?php echo site_url() ?>assets/img/products/6.svg">
                                ...
                                <div class="quantity has-spinner">
                                    <div class="spinner">
                                        ...
                                        <?php foreach ($video_c->result() as $user) {
                                        }
                                        $total_v = count($video_c->result_object);
                                        ?>
                                        <span class="value"><?php echo $total_v?></span>
                                        <button class="add">
                                            <i data-feather="plus"></i>
                                        </button>
                                        <input class="spinner-input" type="hidden" value="1">
                                ...
                                <?php $total_single_v = $single_point_v*$total_v ;?>
                                <div class="total">
                                    <span class="has-price"><?php echo $total_single_v ?></span>
                                </div>
                            </div>
                        </div>
    
                      <?php $sub_total = $total_single_l+$total_single_c+$total_single_p+$total_single_i+$total_single_v;?>


                        <div class="continue-shopping">
                            <a href="<?php echo site_url() ?>">Continue Social media experience </a>
                        </div>
                    </div>
                        ...
                        <div class="cart-summary">
                            ...
                            <div class="summary-card">
                                ...
                                <div class="order-line">
                                    ...
                                    <span class="is-total"><?php echo $sub_total ?></span class="is-total">
                                </div>
                            </div>
