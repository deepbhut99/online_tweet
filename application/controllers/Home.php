...
class Home extends CI_Controller 
{
	...
	public function get_user_friends() 
	{
		...
		if($char == "@") {
			...
			$query2 = substr($query2, 1, strlen($query2));
			$users = $this->user_model->get_trand($query2);
	...
	public function get_user_friends_comment() 
	{
		$query2 = $this->common->nohtml($this->input->get("term"));
		...
		if($char == "@") {
			$query2 = substr($query2, 1, strlen($query2));
			$users = $this->user_model->get_names_com($query2);
			...
			$query2 = substr($query2, 1, strlen($query2));
			$users = $this->user_model->get_trand_com($query2);
